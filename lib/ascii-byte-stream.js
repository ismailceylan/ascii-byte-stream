export default class AsciiByteStream
{
	...
	distanceTo( needle )
	{
		return this.raw.indexOf( needle, this.cursor ) - this.cursor - 1;
	}
	...
	slice( length )
	{
		...
		return this.raw.slice( this.cursor, this.cursor += length );
	}
	...
	jumpTo( target )
	{
		return this.cursor = this.raw.indexOf( target, this.cursor );
	}
